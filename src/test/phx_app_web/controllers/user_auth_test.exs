defmodule PhxAppWeb.UserAuthTest do
  use PhxAppWeb.ConnCase, async: true

  alias PhxApp.Accounts
  alias PhxAppWeb.UserAuth
  import PhxApp.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PhxAppWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PhxAppWeb.Endpoint.subscribe(live_socket_id)
